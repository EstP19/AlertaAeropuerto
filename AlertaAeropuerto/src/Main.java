...
Compania vuelo17 = new Compania("C","SIB01","SPA01","01:00","120","Airbus");
    ...
    agregarInformacion.agregarVuelo(vuelo1);agregarInformacion.agregarVuelo(vuelo2);agregarInformacion.agregarVuelo(vuelo3);
    agregarInformacion.agregarVuelo(vuelo4);agregarInformacion.agregarVuelo(vuelo5);agregarInformacion.agregarVuelo(vuelo6);
    agregarInformacion.agregarVuelo(vuelo7);agregarInformacion.agregarVuelo(vuelo8);agregarInformacion.agregarVuelo(vuelo9);
    agregarInformacion.agregarVuelo(vuelo10);agregarInformacion.agregarVuelo(vuelo11);agregarInformacion.agregarVuelo(vuelo12);
    agregarInformacion.agregarVuelo(vuelo13);agregarInformacion.agregarVuelo(vuelo14);agregarInformacion.agregarVuelo(vuelo15);
    agregarInformacion.agregarVuelo(vuelo16);agregarInformacion.agregarVuelo(vuelo17);

        System.out.println("Informacion Vuelos");
        agregarInformacion.imprimirInformacionVuelos();

        System.out.println("Vuelos de salida desde los aeropuerto ");
        ...
        System.out.println("Vuelos de llegada desde los aeropuerto ");
        for (Aeropuerto aeropuerto : agregarInformacion.getAeropuertos()) {
